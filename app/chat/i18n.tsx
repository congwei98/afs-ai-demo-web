...
const english: Record<string, string> = {
  ...
  "已生成调查计划：查询维修记录、技术方案与代步车资源；按确认范围补充 Warranty 查询。": "Investigation plan prepared: retrieve repair history, technical solution and courtesy car availability. Add Warranty queries within the confirmed scope.",
  ...
  "经销商未来一周有一辆 BMW 5 系代步车可用。": "One BMW 5 Series courtesy car is available at the dealer for the coming week.",
  "FRD 保修开始日：2026 年 4 月 3 日；当前里程：91 km。": "FRD warranty start date: April 3, 2026. Current mileage: 91 km.",
  "已生成客户关怀方案：维修安排、代步车支持及一年延保，并准备客户沟通话术。": "Prepared a customer-care package covering repairs, a courtesy car and a one-year warranty extension, with a communication script.",
  ...
  "Mobility Data Agent 返回：未来一周有一辆 5 系代步车可以使用。": "Mobility Data Agent result: One BMW 5 Series courtesy car is available during the coming week.",
  ...
  "确认出行保障": "Confirm courtesy car support", "查询经销商是否有可用代步车": "Check dealer courtesy car availability", "明确维修期间的出行支持条件": "Confirm courtesy car support during the repair",
  ...
  "延保资料待补充｜CCA-2026-0041": "Warranty-extension documents pending | CCA-2026-0041", "零件延迟投诉｜CCO-CMP-0087": "Parts-delay complaint | CCO-CMP-0087", "道路救援费用核验｜王先生": "Roadside-assistance fee review | Mr. Wang", "重复维修客户关怀｜李女士": "Repeat-repair customer care | Ms. Li", "代步车权益确认｜CCO-CMP-0102": "Courtesy car eligibility confirmation | CCO-CMP-0102", "Dealer 沟通记录待补充｜赵先生": "Dealer contact record pending | Mr. Zhao", "维修方案技术复核｜BMW X5": "Technical review of repair solution | BMW X5", "客户授权文件待签署｜CCA-2026-0071": "Customer authorization awaiting signature | CCA-2026-0071",
  ...
  "Repair History Data Agent 请求业务审批｜4/4 维修记录": "Repair History Data Agent requests approval | Apr 4 repair record", "Technical Service Data Agent 请求业务审批｜4/7 维修方案": "Technical Service Data Agent requests approval | Apr 7 repair solution", "Mobility Data Agent 请求业务审批｜代步车可用性": "Mobility Data Agent requests approval | Courtesy car availability", "Warranty Data Agent 请求业务审批｜FRD 与里程": "Warranty Data Agent requests approval | FRD and mileage",
  "Repair History 已确认｜维修记录": "Repair History approved | Repair record", "Technical Service 已确认｜维修方案": "Technical Service approved | Repair solution", "Mobility 已确认｜代步车安排": "Mobility approved | Courtesy car arrangement", "Warranty 已确认｜FRD 与里程": "Warranty approved | FRD and mileage",
  ...
  "根据客户确认的计划，编排维修记录、技术方案和代步车查询；如业务人员补充新车状态核验，再加入 Warranty Data Agent。": "Orchestrate repair-history, technical-solution, and courtesy car queries according to the confirmed plan. Add the Warranty Data Agent only if the business user requests new-vehicle verification.", "当前 CCO 投诉与用户确认的执行计划": "Current CCO complaint and user-confirmed execution plan", "基于已确认的计划调用所需 Data Agents，并汇总可供客户沟通的事实。": "Call the required Data Agents from the confirmed plan and consolidate facts suitable for customer communication.",
  ...
  "查询经销商未来一周的可用代步车。": "Check the dealer's available courtesy cars for the coming week.", "Dealer Mobility 库存": "Dealer Mobility inventory", "确认未来一周是否有可用的同级代步车。": "Confirm whether a comparable courtesy car is available during the coming week.",
