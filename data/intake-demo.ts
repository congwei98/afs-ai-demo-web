...
export const historicalCalls: HistoricalCall[] = [
  {
    ...
    narrative: "The customer reported the first power-loss incident. Customer Care recorded the issue and arranged the first dealer visit. The customer was concerned but cooperative.",
    insights: [
...
export const intakeDemo = {
  conversation: [
    ...
    { id: "request", speaker: "Customer", time: "00:52", parts: [{ text: "The same problem keeps coming back. I want to " }, { text: "return the vehicle", semantic: "request" }, { text: "." }] },
  ] satisfies ConversationLine[],
  narrative: "The same loss-of-power fault occurred again after five reported repair visits. The customer now feels unsafe driving the vehicle and explicitly requests to return it. The repair count is customer-reported and has not been verified.",
  insights: [
    { key: "reason", label: "Contact reason", value: "Recurring loss of power", evidenceId: "issue", evidenceTime: "00:12" },
    { key: "repair", label: "Repair history", value: "Customer reports 5 visits; unverified", evidenceId: "clarify", evidenceTime: "00:27" },
    { key: "request", label: "Customer request", value: "Return the vehicle", evidenceId: "request", evidenceTime: "00:52" },
